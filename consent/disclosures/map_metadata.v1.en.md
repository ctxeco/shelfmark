# Mapping your folders — what this service reads

You are about to let this service **map** part of your cloud storage. Mapping reads
...
The map becomes part of your workspace on this service. Other people in that workspace
...
The map is stored in your workspace on this service. But when it is used to answer a
...
Mapping is read-only. this service does not create, rename, move, overwrite or delete
...
We do not sell it. We do not share it with other customers of this service — your
workspace is isolated from every other workspace. Neither this service's operator nor the model
providers this service uses train models on it.
