# Qué lee this service cuando mapea sus carpetas

Está por autorizar que este servicio **mapee** una parte de su almacenamiento en la
...
La conexión se hace con su cuenta, así que este servicio solo puede leer lo que usted
ya puede ver en su almacenamiento. Eso limita lo que se lee. **No limita, por sí
solo, quién puede verlo después.**

El mapa pasa a formar parte de su espacio de trabajo en this service. Otras personas
...
El mapa se guarda en su espacio de trabajo de this service. Pero cuando se usa para
...
Mapear es de solo lectura. este servicio no crea, no renombra, no mueve, no sobrescribe
...
No lo vendemos. No lo compartimos con otros clientes de este servicio: su espacio de
trabajo está aislado de todos los demás. Ni el operador de este servicio ni los proveedores de modelos
que este servicio utiliza entrenan modelos con esto.
